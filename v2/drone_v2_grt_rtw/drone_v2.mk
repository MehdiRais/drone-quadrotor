###########################################################################
## Makefile generated for Simulink model 'drone_v2'. 
## 
## Makefile     : drone_v2.mk
## Generated on : Sun Jan 02 15:54:06 2022
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/drone_v2.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/mrais/Documents/GitHub/drone-quadrotor/v2
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = drone_v2_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = drone_v2_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/drone_v2.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/drone_v2_grt_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=drone_v2 -DNUMST=2 -DNCSTATES=14 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/drone_v2_grt_rtw/drone_v2.c $(START_DIR)/drone_v2_grt_rtw/drone_v2_data.c $(START_DIR)/drone_v2_grt_rtw/rtGetInf.c $(START_DIR)/drone_v2_grt_rtw/rtGetNaN.c $(START_DIR)/drone_v2_grt_rtw/rt_nonfinite.c rt_logging.c
...
OBJS = drone_v2.obj drone_v2_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj
...
%.obj : $(START_DIR)/drone_v2_grt_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
